                ...
                <form role="form" method="post" action="<?php echo base_url() ?>admin_users/manage_user<?php if (isset($id)) {
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="box box-primary" style="margin-top: 15px;">
                            ...
                            <div class="box-body">
								 <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('employee_class_label'); ?> <span class="text-danger">*</span></label>
                                    <?php $employees_class = employees_class(); //pre($employees_class);  ?>
                                    <select class="form-control" name="employees_class">
                                        <option value="">Select</option>
                                            <?php foreach ($employees_class as $yky => $yval) { ?>
                                                <option value="<?php echo $yky; ?>" <?php if (@$emp_more_detail['emp_class'] == $yky) {echo 'selected';} else if ($this->input->post('employees_class') == $yky) {echo 'selected';} ?>><?php echo $yval; ?></option>
                                            <?php } ?>
                                    </select>
                                    <?php  echo form_error('employees_class'); ?>
                                </div>
								<div class="form-group">
                                    <label for="exampleInputFile"><?php echo $this->lang->line('employee_doj_label'); ?> <span class="text-danger">*</span></label>
									<input type="text" id="employee_doj" name="employee_doj" value="<?php echo (@$emp_more_detail['emp_joining_date']) ? date('d-m-Y' , strtotime($emp_more_detail['emp_joining_date'])) : $this->input->post('employee_doj'); ?>"  class="form-control" placeholder="dd-mm-yyyy">
